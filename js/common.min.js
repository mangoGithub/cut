...
jQuery.fn.dialogOpen = function (fn){
	...
	function init(){
		...
		box.each(function(i){
			$(this).css({"left" : "50%", "margin-left" : -$(this).outerWidth()/2, "z-index" : "10000011",height:$(this).height()});
...
jQuery.fn.dialog = function (){
	...
	function init(){
		...
		box.each(function(i){
			$(this).css({"left" : "50%", "margin-left" : -$(this).outerWidth()/2, "z-index" : "1000001"});
			var T = ( $(window).innerHeight() - $(this).outerHeight() )/2;
			isIe6() ? $(this).css({"top" : $(window).scrollTop() + T }) : $(this).css({"top" : T});
			//console.log(T)
		})
...
$(function(){
	$(".ft_btn_share li").hover(function(){
		$(this).find(".codeimg").toggleClass("hide");
	})
})